...
# Using ResNet-50 pretrained model for image classification
...
class_labels = model.fc.out_features
...
resultados_folder = 'Resultados_Resnet'  # Ruta a la carpeta de resultados
...
csv_folder = 'CSVs'
csv_filename = os.path.join(csv_folder, 'resnet_results.csv')
...
print(f"Tiempo de ejecución Resnet: {execution_time} segundos")