...
#class_labels = model.classifier[6].out_features
...
model.classifier[6] = torch.nn.Linear(num_features, num_reduced_labels)

# Obtener la ruta completa de la carpeta de resultados
resultados_folder = 'Resultados_VGG16'  # Ruta a la carpeta de resultados
...
csv_folder = 'CSVs'
csv_filename = os.path.join(csv_folder, 'vgg16_results.csv')
...
print(f"Tiempo de ejecución VGG16: {execution_time} segundos")