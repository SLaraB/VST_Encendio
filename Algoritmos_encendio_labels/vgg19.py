...
resultados_folder = 'Resultados_VGG19'  # Ruta a la carpeta de resultados
...
csv_folder = 'CSVs'
csv_filename = os.path.join(csv_folder, 'vgg19_results.csv')
...
print(f"Tiempo de ejecución VGG19: {execution_time} segundos")